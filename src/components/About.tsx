...
export default function About() {
  ...
  return (
    <section id="sobre" className="py-24 bg-bg-primary overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-[30px] md:text-[34px] font-display font-bold text-[#112A32] leading-[1.2] mb-4 max-w-[500px]">
